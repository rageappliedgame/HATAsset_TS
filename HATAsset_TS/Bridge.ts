/// <reference path="../../asset-proof-of-concept-demo_TypeScript/RageAssetManager/IBridge.ts"/>
/// <reference path="../../asset-proof-of-concept-demo_TypeScript/RageAssetManager/IDataStorage.ts"/>
/// <reference path="../../asset-proof-of-concept-demo_TypeScript/RageAssetManager/IDefaultSettings.ts"/>
...
module MyNameSpace {
    ...
    /// Export the Asset.
    /// </summary>
    export class Bridge implements IBridge, ILog, IDataStorage, IDefaultSettings {
